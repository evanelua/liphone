  ...
  return (
    <div className="pt-24 pb-20 min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Admin Help Card */}
        <div className="mb-10">
          <div className="relative overflow-hidden rounded-3xl shadow-xl border border-blue-200 bg-gradient-to-br from-blue-50 via-white to-blue-100 p-0.5">
            <div className="absolute -top-10 -left-10 w-40 h-40 bg-gradient-to-br from-blue-200/60 to-blue-400/30 rounded-full blur-2xl z-0"></div>
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-6 p-7 md:p-9">
              <div className="flex-shrink-0 flex items-center justify-center w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-blue-300 via-blue-200 to-blue-100 rounded-2xl shadow-lg border-4 border-blue-100">
                <svg className="w-12 h-12 md:w-14 md:h-14 text-blue-500" fill="none" viewBox="0 0 48 48" stroke="currentColor">
                  <circle cx="24" cy="24" r="22" strokeWidth="3" className="text-blue-200" fill="currentColor" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M24 18v6m0 6h.01" className="text-blue-700" stroke="currentColor" />
                </svg>
              </div>
              <div className="flex-1">
                <h3 className="font-extrabold text-xl md:text-2xl text-blue-800 mb-2 tracking-tight">Butuh Bantuan Admin?</h3>
                <p className="text-blue-900 text-base md:text-lg mb-3">Tim admin kami siap membantu Anda jika ada kendala, pertanyaan, atau butuh konfirmasi proses tukar tambah.</p>
                <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 text-white font-bold shadow-lg transition-all text-base md:text-lg">
